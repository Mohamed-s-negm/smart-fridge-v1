...
class DL_ImgClass:
    ...
    def __init__(self, device=None, num_classes=None, model_path=None, num_epochs=10, batch_size=32, lr=0.0001):
    ...
    def _init_model(self):
        ...
        self.optimizer = optim.Adam(vgg16.classifier[6].parameters(), lr=self.lr)
